...
function Card({ id, imageFileName, imageAltText, languages, name, averagePrice, rating, reviewsCount }) {
    return (
        <>
            <NavLink to={`/hotel/${id}/`}>
                <div className="mb-6 transition ease-in-out delay-150 hover:scale-105">
                    <div className="relative w-96 h-64">
                        <img src={`http://127.0.0.1:3030/public/assets/images/hotel/${imageFileName}`} alt={imageAltText} className="absolute w-96 h-64 object-cover rounded-lg shadow-md" />
                    </div>
                    <div className="relative px-4 -mt-16">
                        <div className="bg-white p-4 rounded-lg shadow-lg">
                            ...
                            <div className="inline-flex">
                                <span className="font-sans text-sm font-normal tracking-widest leading-normal text-center text-blue-600">{averagePrice}&euro;</span>
